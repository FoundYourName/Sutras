...
var cookieDomain = "http://www.sanbao.vip"; //更改为你的博客网址
...
document.writeln("<div id=\"myBtn\">回到顶部</div>");
document.writeln("<div style=\"visibility:hidden\"><script type=\"text/javascript\" src=\"https://s4.cnzz.com/z_stat.php?id=1280789631&web_id=1280789631\" type=\"hidden\"></script></div>");
document.writeln("<script>  ");
document.writeln("window.onscroll = function() {scrollFunction() };");
document.writeln("function scrollFunction() {");
document.writeln("console.log(121);");
...
document.writeln("myBtn.onclick=function(){");
